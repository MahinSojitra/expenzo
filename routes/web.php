...
use App\Core\Router; use App\Controllers\AuthController;use App\Controllers\DashboardController;use App\Controllers\ExpenseController;use App\Controllers\CategoryController;use App\Controllers\AccountController;use App\Controllers\BudgetController;use App\Controllers\ReportController;use App\Controllers\UserController;use App\Controllers\SettingsController;
return static function(Router $r):void{
 $r->get('/','App\Controllers\DashboardController@index');$r->get('/login','App\Controllers\AuthController@showLogin');$r->post('/login','App\Controllers\AuthController@login');$r->get('/register','App\Controllers\AuthController@showRegister');$r->post('/register','App\Controllers\AuthController@register');$r->get('/logout','App\Controllers\AuthController@logout');
 ...
 $r->get('/accounts','App\Controllers\AccountController@index');$r->post('/accounts','App\Controllers\AccountController@store');$r->post('/accounts/{id}','App\Controllers\AccountController@update');
