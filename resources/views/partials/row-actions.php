<div class="table-actions">
    ...
    <?php if ($module === 'categories' && can('categories.customize')): ?><a class="btn btn-sm btn-outline-secondary" href="<?=e(url('categories/'.$rowId.'/appearance'))?>">Appearance<span class="visually-hidden"> for <?=e($rowName)?></span></a><?php endif; ?>
    <?php if ($mayDelete): ?>
    ...
    <?php endif; ?>
    <?php if (!$mayEdit && !$mayDelete && !($module === 'categories' && can('categories.customize'))): ?><span class="text-muted">&mdash;</span><?php endif; ?>
</div>